// TxBtc Programming Interface 1.0.0
...
#define X_MULTIPLIER 1
	...
	static sint64 transfer( // Attempts to transfer energy from this tx_btc
...
#define INITIALIZE                                                                          \
public:                                                                                     \
	static void __initialize(CONTRACT_STATE_TYPE &state)                                    \
	{                                                                                       \
...
#define BEGIN_EPOCH                                                                         \
public:                                                                                     \
	static void __beginEpoch(CONTRACT_STATE_TYPE &state)                                    \
	{                                                                                       \
		constexpr unsigned int __functionOrProcedureId = (CONTRACT_INDEX << 22) | __LINE__; \
		::__beginFunctionOrProcedure(__functionOrProcedureId);
...
#define END_EPOCH                                                                           \
public:                                                                                     \
	static void __endEpoch(CONTRACT_STATE_TYPE &state)                                      \
	{                                                                                       \
		constexpr unsigned int __functionOrProcedureId = (CONTRACT_INDEX << 22) | __LINE__; \
		::__beginFunctionOrProcedure(__functionOrProcedureId);
...
#define BEGIN_TICK                                                                          \
public:                                                                                     \
	static void __beginTick(CONTRACT_STATE_TYPE &state)                                     \
	{                                                                                       \
		constexpr unsigned int __functionOrProcedureId = (CONTRACT_INDEX << 22) | __LINE__; \
		::__beginFunctionOrProcedure(__functionOrProcedureId);
...
#define END_TICK                                                                            \
public:                                                                                     \
	static void __endTick(CONTRACT_STATE_TYPE &state)                                       \
	{                                                                                       \
		constexpr unsigned int __functionOrProcedureId = (CONTRACT_INDEX << 22) | __LINE__; \
		::__beginFunctionOrProcedure(__functionOrProcedureId);
...
#define EXPAND                                                                              \
public:                                                                                     \
	static void __expand(CONTRACT_STATE_TYPE &state, CONTRACT_STATE2_TYPE &state2)          \
	{                                                                                       \
		constexpr unsigned int __functionOrProcedureId = (CONTRACT_INDEX << 22) | __LINE__; \
		::__beginFunctionOrProcedure(__functionOrProcedureId);
...
#define PRIVATE(functionOrProcedure)                                                                                                          \
private:                                                                                                                                      \
	static void functionOrProcedure(CONTRACT_STATE_TYPE &statetate, functionOrProcedure##_input &input, functionOrProcedure##_output &output) \
	{                                                                                                                                         \
		constexpr unsigned int __functionOrProcedureId = (CONTRACT_INDEX << 22) | __LINE__;                                                   \
		::__beginFunctionOrProcedure(__functionOrProcedureId);

#define PUBLIC(functionOrProcedure)                                                                                                       \
public:                                                                                                                                   \
	static void functionOrProcedure(CONTRACT_STATE_TYPE &state, functionOrProcedure##_input &input, functionOrProcedure##_output &output) \
	{                                                                                                                                     \
		constexpr unsigned int __functionOrProcedureId = (CONTRACT_INDEX << 22) | __LINE__;                                               \
		::__beginFunctionOrProcedure(__functionOrProcedureId);

#define REGISTER_USER_FUNCTIONS                                                             \
public:                                                                                     \
	static void __registerUserFunctions()                                                   \
	{                                                                                       \
		constexpr unsigned int __functionOrProcedureId = (CONTRACT_INDEX << 22) | __LINE__; \
		::__beginFunctionOrProcedure(__functionOrProcedureId);

#define REGISTER_USER_PROCEDURES                                                            \
public:                                                                                     \
	static void __registerUserProcedures()                                                  \
	{                                                                                       \
		constexpr unsigned int __functionOrProcedureId = (CONTRACT_INDEX << 22) | __LINE__; \
		::__beginFunctionOrProcedure(__functionOrProcedureId);

#define _                                                \
	::__endFunctionOrProcedure(__functionOrProcedureId); \
	}
