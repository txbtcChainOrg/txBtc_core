...
class BIP66Test(txbtcTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # txbtcd is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and txbtcd produces more specific reject
            # reasons.
