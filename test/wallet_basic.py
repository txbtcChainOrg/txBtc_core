...
class WalletTest(txbtcTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 TXBTC from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 TXBTC with subtract fee from amount
        ...
        # Sendmany 10 TXBTC with subtract fee from amount
